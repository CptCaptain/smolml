...
class _MixerState:
    ...
    # Optional fast-weight stream (DeltaMix only; None for count-only models): the per-stream
    # delta-rule W + the pending delta key/prediction graded next step (see delta_mix).
